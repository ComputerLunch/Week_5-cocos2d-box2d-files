...
-(void)makeABallx:(float)x y:(float)y{
    ...
    CCSprite *pretzSprite = [CCSprite spriteWithFile:@"pretz.png"
                                         rect:CGRectMake(0, 0, 52, 52)];
    pretzSprite.position = ccp(100, 100);
   // pretzSprite.tag = 1;
    [self addChild:pretzSprite];
    ...
    // Add user data of graphic
    ballBodyDef.userData = pretzSprite;
